...
/**
 * Home page for ME-SEUM application
 * NOTE: NavigationBar is managed by Main.java - do NOT add it here
 */
public class HomePage extends BorderPane {
    ...
    private void setupLayout() {
        ...
        // Set layout - NO NAVIGATION BAR (managed by Main.java)
    ...
    private VBox createHeroSection() {
        ...
        // Use img/home/1.png as hero background
        try {
        ...
        // Hero content with semi-transparent overlay
        ...
        // Navigation handled by Main.java - no action needed here
    ...
    private VBox createWelcomeSection() {
        ...
        // Use img/home/2.png for welcome section
        ...
        try {
            ...
            if (getClass().getResourceAsStream(welcomeImagePath) != null) {
                ...
                // You could create a placeholder here if needed
            }
        } catch (Exception e) {
    ...
    /**
     * Create upcoming exhibitions section
     */
    private VBox createExhibitionsSection() {
        ...
        // Use img/home/3.png for exhibition image
    ...
    private VBox createCollectionSection() {
        ...
        // Create collection items (3x3 grid)
