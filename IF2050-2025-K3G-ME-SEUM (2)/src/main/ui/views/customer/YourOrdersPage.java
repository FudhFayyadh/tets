...
public class YourOrdersPage extends VBox implements NavigationBar.NavigationListener {
    ...
    /**
     * Load sample orders (Your Orders content)
     */
    private void loadSampleOrders() {
        ordersContainer.getChildren().clear();
        
        // Add multiple order cards to demonstrate scrolling
        for (int i = 0; i < 3; i++) {
            createOrderCard(
     ...
     */
    private void createOrderCard(String eventName, String dateRange, String timeRange, String location, String orderId) {
        ...
        // Hover effect
        openTicketButton.setOnMouseEntered(e -> 
            openTicketButton.setStyle(
        ...
        openTicketButton.setOnMouseExited(e -> 
            openTicketButton.setStyle(
                "-fx-background-color: #007bff;" +
                "-fx-text-fill: white;" +
                "-fx-padding: 8 16;" +
