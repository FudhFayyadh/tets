...
public class RegisterPage extends BorderPane {
    ...
    private TextField usernameField; // ADD THIS FIELD
    private TextField fullNameField; // ADD THIS FIELD
    private TextField emailField;
    private PasswordField passwordField;
    private PasswordField confirmPasswordField; // ADD THIS FIELD
    private ComboBox<UserRole> roleComboBox; // CHANGE TYPE FROM String TO UserRole
    private CheckBox agreeTermsCheckBox; // RENAME FROM rememberMeCheckBox
    ...
    private void setupLayout() {
        ...
        // Right side - Dark panel with form
        VBox rightSide = new VBox();
        rightSide.setPrefWidth(600);
        rightSide.setStyle("-fx-background-color: rgba(31, 31, 31, 0.95);");
        ...
        VBox formContainer = new VBox(15); // CHANGE SPACING FROM 20 TO 15
        ...
        formContainer.getChildren().addAll(
            ...
            roleLabel,
            roleComboBox,
            agreeTermsCheckBox, // CHANGE FROM rememberMeCheckBox
    ...
    /**
     * Clear the form - ADD THIS METHOD
     */
    ...
    private void showAlert(String title, String message) {
        ...
        alert.setHeaderText(null); // ADD THIS LINE
    ...
    /**
     * Interface for register events - UPDATED SIGNATURE
     */
    public interface RegisterListener {
        void onRegisterSuccess(UserDto user); // UPDATED: now accepts UserDto parameter
        void onBackToLogin();
        void onHomeRequested(); // KEEP THIS from your existing code
    }
}