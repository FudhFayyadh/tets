...
public class Main extends Application implements NavigationBar.NavigationListener, SideBar.NavigationListener, 
    ...
    public void onNavigate(String destination) {
        ...
        switch (destination) {
            ...
            case "EVENT":
                ...
                break;
            case "CONTACT":
                // Contact is handled within HomePage - scroll to footer
                // No navigation needed, just handled by HomePage itself
                break;
            case "LOGOUT":
                handleLogout();
                break;
    ...
    public void onLoginSuccess(String role, UserDto user) {
        ...
        System.out.println("Login successful! Role: " + role + ", User: " + (user != null ? user.getUsername() : "null"));
    ...
    /**
     * Show artifact page - this is now the main curator dashboard with artifact list
     */
    ...
    */
    private void showEventArtifactPage() {
        ...
        Label descLabel = new Label("Manage museum events, exhibitions, and artifact displays");
        descLabel.setFont(Font.font("System", 14));
        descLabel.setTextFill(Color.web("#6c757d"));
        
        Label placeholderLabel = new Label("🏛️ Event management features will be implemented here");
        ...
        System.out.println("✅ Event Artifact Page loaded!");
    }
